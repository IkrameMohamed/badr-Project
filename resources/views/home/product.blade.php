    ...
    <div class="header_section">
        <div class="container">
            <div class="containt_main">
                ...
                <span class="toggle_icon" onclick="openNav()"><img src={{asset('extrat/images/toggle-icon.png')}}
></span>
                <div class="dropdown">
        ...
        <div class="carousel-inner">
            ...
            @php
                $newProductsList = array_filter($products->toArray(), function($item) {
                  ...
                  $iteration = 0 ;
            @endphp
            @foreach (array_chunk($newProductsList, 3) as $productListOfThree)
                <div class="carousel-item {{ $iteration == 0 ? 'active' : '' }}">
                    <div class="container">
                        <h1 class="fashion_taital" style=" color: #fd7e14;">Les Medécament</h1>
...
<div class="fashion_section">
    <div id="electronic_main_slider" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            @php
                $newProductsList = array_filter($products->toArray(), function($item) {
                   return  $item['category'] == 'CHAISE_ROULENT';
                });
            ...
            @foreach (array_chunk($newProductsList, 3) as $productListOfThree)
                <div class="carousel-item {{ $iteration == 0 ? 'active' : '' }}">
                    <div class="container">
                        <h1 class="fashion_taital" style=" color: #fd7e14;">les chaises roulantes</h1>
                        <div class="fashion_section_2">
                            <div class="row">
                                @foreach ($productListOfThree as $item)
                                    <div class="col-lg-4 col-sm-4">
...
<div class="jewellery_section">
    <div id="jewellery_main_slider" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            @php
                $newProductsList = array_filter($products->toArray(), function($item) {
                   return  $item['category'] == 'EQUIPEMENT_MEDICO';
                });
...
<div class="copyright_section">
    <div class="container">
        <div class="copyright_text">
            <p><img src={{asset('extrat/images/mail.svg')}} height="25px" width="25px" alt="">
                association.elbadr@gmail.com</p>
            <p><img src={{asset('extrat/images/contact.svg')}} height="25px" width="25px" alt=""> +213 25 30 06 18 <br>
                <img src={{asset('extrat/images/contact.svg')}}  height="25px" width="25px" alt=""> +213 561 73 37 26
            </p>
            <p><img src={{asset('extrat/images/localisation.svg')}} height="25px" width="25px" alt=""> Rue Javal, Blida–
                Algerie</p>
        </div>
    </div>
</div>
